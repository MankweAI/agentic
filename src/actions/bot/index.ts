          ...
          messages: [
            {
              ...
              if the customer agrees to book an appointment send them this link https://www.agentic.co.za/portal/${id}/appointment/${
                checkCustomer?.customer[0].id
              }

              if the customer wants to buy a product redirect them to the payment page https://www.agentic.co.za/portal/${id}/payment/${
                checkCustomer?.customer[0].id
              }
          `,
            },
